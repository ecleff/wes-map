...
wes_data <- data.frame("Place" = c("[Select location]",
                       ...
                       "Longitude" = c(-72.6569, -72.657304, -72.653872 , -72.666572, -72.662807, -72.660037,-72.651434, -72.653768, -72.657644,
                       ...
                       "Latitude" = c(41.5566, 41.553502, 41.556218 , 41.544479, 41.556045, 41.553141, 41.556051, 41.554871, 41.559195,
                       ...
                       "Zoom"=c(12, 17.5, 17.5, 16.5,  16.5,  16.5, 17.5, 17.5, 17.5, 14.5, 14.5, 17.5, 17.5, 17.5, 17.5,
                                17.5, 17.5, 17.5, 17.5, 17.5, 17.5, 17.5, 17.5, 17.5, 17.5, 17.5),
                       "Color"=c("white", "red","red","red", "red", "red", "red", "red", "red", "red", "red", "red", 
                                 "red", "red", "red", "red", "red", "red", "red", "red", "red", "red", 
                                 "red", "red", "red", "red"),
                       "Opacity"=c(.1, .7, .7, .7, .7, .7, .7, .7, .7, .7, .7, .7, .7, .7, .7, 
